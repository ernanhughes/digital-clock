package com.banba.digitalclock.anim;
 ...
 */
public final class GetToTheMiddleOfFlipping implements AnimationListener {
     ...
     *
     * @param originalViewIndex      current view index
     * @param views                  views
     * @param animationLength        length of animation
     * @param direction              direction in which to animate
     * @param finishFlippingListener listener to run on finishing flipping
     */
