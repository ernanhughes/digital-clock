...
public final class SwapViews implements Runnable {
     ...
     *
     * @param originalViewIndex      original index of the view
     * @param views                  views to swap
     * @param animationLenght        length of the animation
     * @param direction              direction of the animation
     * @param finishFlippingListener what to do when the whole animation is finished
     */
